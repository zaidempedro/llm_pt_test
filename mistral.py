...
hf_token = os.getenv("HF_TOKEN")  # pega o token da variável de ambiente

if hf_token is None:
    raise ValueError("Variável de ambiente HF_TOKEN não está definida.")
...
def processar_arquivos(pasta_entrada="textos_originais", pasta_saida="textos_traduzidos_mistral"):
